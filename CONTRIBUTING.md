...
هر پرونده `.po` شامل جفت‌های `msgid` (متن انگلیسی) و `msgstr` (ترجمه‌ی فارسی) است.
...
1. پرونده‌ای را انتخاب کنید و بررسی کنید آیا [ایشیوی](https://github.com/python/python-docs-fa/issues) مربوط به آن باز شده است یا نه (قالب «درخواست ترجمه‌ی صفحه»). اگر باز شده و ترجمه‌ی کامل آن در حال انجام است، پرونده دیگری را انتخاب کنید؛ در غیر این صورت یک ایشیو باز کرده و شروع به کار کنید.
2. پرونده `.po` مورد نظر را با [Poedit](https://poedit.net) یا هر ویرایشگر متنی باز کنید.
...
هر پرونده `.po` در بخش سرآیند خود دو جایگاه برای ثبت اعتبار دارد:
